        ...
        <section className="auth-panel auth-panel-role">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div>
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-4 rounded-[1.5rem] border border-slate-200 bg-slate-50 px-5 py-4 text-sm text-slate-600">
