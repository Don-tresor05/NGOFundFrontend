      ...
      transData.forEach((t: any) => {
        ...
        if (amount > 10000) {
          exceptionList.push({
            ...
            description: `Transaction of $${amount.toLocaleString()} requires review`,
      ...
      budgetData.forEach((b: any) => {
        ...
        if (spent > allocated) {
          exceptionList.push({
            ...
            severity: 'HIGH',
            title: `Budget exceeded for ${b.category}`,
            description: `Spent $${spent.toLocaleString()} exceeds allocated $${allocated.toLocaleString()}`,
            entity_type: 'BUDGET',
            entity_id: b.id,
